...
const ProfileDetails = props => {
  ...
  const saveReason = () => {
   ...
   else if (values.actions == 2 && (values.destination_bank == -1 || values.customers_reason == -1 || values.account_holder == -1)) {
      setValues({
        ...values,
        inputError: true
      });
    } 
    else if (values.account_holder == 2 && values.beneficiary_name.trim() === '') {
      setValues({
        ...values,
            ...
            <Grid container spacing={3}>
              ...
              <Grid item md={6} xs={12}>
                <TextField
                  ...
                  error={values.account_holder == -1 ?  values.inputError ?   true : false :''}
                  required
                  select
                  SelectProps={{ native: true }}
              ...
              <Grid item md={6} xs={12}>
                <TextField
                  ...
                  disabled={values.disabled}
                  select
                  error={values.destination_bank == -1 ?  values.inputError ?   true : false :''}
                  SelectProps={{ native: true }}
              ...
              <Grid item md={6} xs={12}>
                <TextField
                  ...
                  required
                  select
                  error={values.customers_reason == -1 ?  values.inputError ?   true : false :''}
                  SelectProps={{ native: true }}
                  value={values.banks}
                  variant="outlined"
                >
