...
const LoginView = () => {
  ...
  if (role == 10) {
    urlPart = '/student_login';
  } else if (role == 20) {
    urlPart = '/instructor_login';
  } else if (role == 30) {
    urlPart = '/admin_login';
  }
        ...
        .then(
          login => {
            ...
            //  localStorage.setItem('position', login.data.position);             
              ...
              alert(login.data.result.studentLogged);
  ...
  return (
    <Page className={classes.root} title="Login">
      ...
      >
        {adminLogged ? <Navigate to="/rms2/app/department" /> : ''}
        {studentLogged ? <Navigate to="/rms2/app/customers" /> : ''}
